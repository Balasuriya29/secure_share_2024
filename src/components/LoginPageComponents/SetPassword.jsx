...
const SetPassword = () => {
  ...
  return (
    <>
      ...
      <PasswordTextField value={password} setValue={setPassword} placeholder={"Password"} />
      <PasswordTextField value={confirmPassword} setValue={setConfirmPassword} placeholder={"Set Password"} />
      <div 
